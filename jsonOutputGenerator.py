...
def generateOutput(pdf_link, apply_link):
    ...
    user_prompt = f"""
        ...
        Give me only the proper JSON Object with proper opening and ending brackets as response, not the code to generate it.
        """
...
def call_ollama_api(prompt, output_file="output.json"):
    ...
    payload = {
        "model": "openchat:latest",  # Replace with your model name
        "prompt": prompt,
        "stream": False
    }
    headers = {
